...
import { faApple, faFacebook, faInstagram, faSpotify, faYoutube } from '@fortawesome/free-brands-svg-icons'
        ...
        <Row>
          <Col xs={12}>
            <Nav className="me-auto flex-column">
              ...
              <Nav.Link className="d-flex flex-row align-items-center" href="#instagram">
              <span className={styles.Instagram}><FontAwesomeIcon icon={faInstagram} className="mr-2 p-2" width="30"/></span> <span className={styles.LinkText}>Find us on Instagram</span>
              </Nav.Link>
              <Nav.Link className="d-flex flex-row align-items-center" href="#instagram">
